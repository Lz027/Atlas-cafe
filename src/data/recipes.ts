...
const T: Tuple[] = [
  ...
  [
    ...
    "Medium",
    ["Floral", "Citrus"],
    "Bright, layered, and easy to repeat. A single-origin V60 for the slow end of the morning.",
  ],
  [
    "Afternoon V60",
    "V60",
    ...
    "Light",
    ["Citrus", "Caramel"],
    "Juicy, tea-like, and bright — a clean second cup.",
  ],
  [
    "Nairobi Dawn",
    "V60",
    ...
    "Medium",
    ["Berry", "Citrus"],
    "Blackcurrant and grapefruit over a syrupy body.",
  ],
  [
    "Andes Window",
    "V60",
    ...
    "Medium",
    ["Caramel", "Chocolate"],
    "Rounded sweetness with a cocoa finish.",
  ],
  [
    "Monsoon Pour",
    "V60",
    ...
    "Bold",
    ["Spiced", "Nutty"],
    "Low acid, heavy body, warm spice.",
  ],
  [
    "First Light",
    "V60",
    ...
    "Light",
    ["Floral", "Fruity"],
    "Delicate florals with a stone-fruit heart.",
  ],
  [
    "Ember Cup",
    "V60",
    ...
    "Bold",
    ["Chocolate", "Nutty"],
    "A darker V60 that drinks like comfort.",
  ],
  // Chemex
  [
    "Weekend Chemex",
    ...
    "Medium",
    ["Floral", "Berry"],
    "Big body, clean finish — worth the slower morning.",
  ],
  [
    "Long Table",
    "Chemex",
    ...
    "Medium",
    ["Floral", "Citrus"],
    "A brew for two, floral and luminous.",
  ],
  [
    "Amber Hour",
    "Chemex",
    ...
    "Medium",
    ["Caramel", "Citrus"],
    "Honeyed sweetness in a clear cup.",
  ],
  [
    "Slow Sunday",
    "Chemex",
    ...
    "Bold",
    ["Chocolate", "Caramel"],
    "A house blend built for the big carafe.",
  ],
  [
    "Cedar Room",
    "Chemex",
  ...
  [
    ...
    "Light",
    ["Floral", "Fruity"],
    "Jasmine and peach, almost tea-like.",
  ],
  // French Press
  [
    "Sunday French Press",
  ...
  [
    ...
    "Bold",
    ["Chocolate", "Spiced"],
    "Full immersion at its heaviest and happiest.",
  ],
  [
    "Garden Press",
    "French Press",
    ...
    "Light",
    ["Floral", "Berry"],
    "Proof that a press can keep its florals.",
  ],
  [
    "Kitchen Table",
    "French Press",
    ...
    "Medium",
    ["Nutty", "Caramel"],
    "An everyday press with a soft nutty core.",
  ],
  [
    "Dusk Press",
    "French Press",
    ...
    "Bold",
    ["Chocolate", "Nutty"],
    "Decadent and low-key; good with milk.",
  ],
  [
    "River Bend",
    "French Press",
    ...
    "Medium",
    ["Fruity", "Caramel"],
    "Plum and panela in a heavy cup.",
  ],
  // Cold Brew
  [
    "Overnight Cold Brew",
  ...
  [
    ...
    "Medium",
    ["Chocolate", "Fruity"],
    "A balanced house cold brew for the fridge door.",
  ],
  [
    "Bright Ice",
    "Cold Brew",
    ...
    "Medium",
    ["Citrus", "Berry"],
    "Cold-steeped Kenyan that keeps its sparkle.",
  ],
  [
    "Concentrate No. 4",
    "Cold Brew",
    ...
    "Bold",
    ["Chocolate", "Nutty"],
    "A 1:8 concentrate — cut with water or milk.",
  ],
  [
    "Melon & Dusk",
    "Cold Brew",
    ...
    "Light",
    ["Floral", "Fruity"],
    "Floral, juicy, dangerously drinkable over ice.",
  ],
  [
    "Midnight Shift",
    "Cold Brew",
    "Blend",
    "Vietnam Robusta blend",
    "Dark",
    80,
    1000,
    null,
    ...
    "Bold",
    ["Chocolate", "Spiced"],
    "Dark, thick, and built for long nights.",
  ],
  // AeroPress
  [
    "Competition Press",
    ...
    "Light",
    ["Floral", "Citrus"],
    "Inverted, fast, and trophy-bright.",
  ],
  [
    "Desk Job",
    "AeroPress",
    ...
    "Medium",
    ["Caramel", "Nutty"],
    "Forgiving office brew with lower water temperature.",
  ],
  [
    "Trail Cup",
    "AeroPress",
    ...
    "Bold",
    ["Chocolate", "Nutty"],
    "Campsite-proof: coarse, quick, sturdy.",
  ],
  [
    "Espresso-Style 60",
    "AeroPress",
    ...
    "Bold",
    ["Chocolate", "Spiced"],
    "A concentrated press for milk drinks.",
  ],
  [
    "Slow Inversion",
    "AeroPress",
  ...
  [
    ...
    "Medium",
    ["Caramel", "Floral"],
    "Double-filtered clarity with a pressed body.",
  ],
  [
    "Night Cap",
    "AeroPress",
  ...
  [
    ...
    "Bold",
    ["Berry", "Floral"],
    "Tight 1:1.5 ratio; intense and perfumed.",
  ],
  [
    "Lungo Light",
    "Espresso",
    ...
    "Light",
    ["Citrus", "Caramel"],
    "A longer pull that stays sweet.",
  ],
  [
    "Napoli Dark",
    "Espresso",
    ...
    "Bold",
    ["Chocolate", "Spiced"],
    "Southern-Italian style: short, thick crema.",
  ],
  [
    "Single Origin Sunday",
    "Espresso",
    "Arabica",
    ...
    "Medium",
    ["Fruity", "Caramel"],
    "A fruit-forward single origin under pressure.",
  ],
  [
    "Flat White Base",
    "Espresso",
  ...
  [
    ...
    "Medium",
    ["Berry", "Citrus"],
    "Blackcurrant brightness in a tiny cup.",
  ],
  // Moka Pot
  [
    "Stovetop Standard",
    ...
    "Bold",
    ["Chocolate", "Nutty"],
    "The classic kitchen moka, dense and bittersweet.",
  ],
  [
    "Nonna's Pot",
    "Moka Pot",
  ...
  [
    ...
    "Medium",
    ["Caramel", "Fruity"],
    "Preheated water keeps it sweet, not scorched.",
  ],
  [
    "Havana Morning",
    "Moka Pot",
    ...
    "Bold",
    ["Chocolate", "Caramel"],
    "Whip the first drops with sugar for espuma.",
  ],
  [
    "Alpine Moka",
    "Moka Pot",
    ...
    "Medium",
    ["Nutty", "Spiced"],
    "A cabin brew with a cinnamon edge.",
  ],
  [
    "Soft Bitter",
    "Moka Pot",
    ...
    "Medium",
    ["Fruity", "Chocolate"],
    "A lighter moka that keeps its fruit.",
  ],
  // Kalita Wave
  [
    "Flat Bed Friday",
  ...
  [
    ...
    "Light",
    ["Floral", "Citrus"],
    "The flat bed flatters delicate lots.",
  ],
  [
    "Commuter Cup",
    "Kalita Wave",
    ...
    "Medium",
    ["Nutty", "Caramel"],
    "Fast, repeatable, forgiving before work.",
  ],
  [
    "Deep Wave",
    "Kalita Wave",
    ...
    "Bold",
    ["Spiced", "Chocolate"],
    "Heavy body through a paper filter.",
  ],
  [
    "Golden Hour",
    "Kalita Wave",
    ...
    "Light",
    ["Floral", "Fruity"],
    "Honeyed florals at golden hour.",
  ],
  // Phin
  [
    "Saigon Street",
    ...
    "Bold",
    ["Chocolate", "Nutty"],
    "Intense and slow; perfect over condensed milk.",
  ],
  [
    "Cà Phê Đá",
    "Phin",
  ...
  [
    ...
    "Medium",
    ["Fruity", "Caramel"],
    "A gentler phin from highland Arabica.",
  ],
  // Turkish
  [
    "Istanbul Classic",
    ...
    "Bold",
    ["Spiced", "Chocolate"],
    "Unfiltered, foamed, and meant for conversation.",
  ],
  [
    "Cardamom Cup",
    "Turkish",
    ...
    "Bold",
    ["Spiced", "Floral"],
    "A pinch of cardamom in the cezve.",
  ],
];
